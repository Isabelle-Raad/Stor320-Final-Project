...
```{r}
kbl(cbind(fema_data[1:10,], fema_data[1:10,])) %>%
  kable_paper() %>%
...
```{r}
kbl(cbind(data2002[1:10,], data2002[1:10,])) %>%
  kable_paper() %>%
  scroll_box(width = "100%", height = "200px")
```
...
```{r}
kbl(cbind(sample2002[1:10,], sample2002[1:10,])) %>%
  kable_paper() %>%
  scroll_box(width = "100%", height = "200px")
```
...
kbl(cbind(data1[1:10,], data1[1:10,])) %>%
  kable_paper() %>%
  scroll_box(width = "100%", height = "200px")
```
...
kbl(cbind(data2[1:10,], data2[1:10,])) %>%
  kable_paper() %>%
  scroll_box(width = "100%", height = "200px")
```
...
kbl(cbind(data3[1:10,], data3[1:10,])) %>%
  kable_paper() %>%
  scroll_box(width = "100%", height = "200px")
```
